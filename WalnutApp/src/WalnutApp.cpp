...
void InitializeImGui()
{
    ...
    // Other ImGui initialization code...
}
...
public:
    virtual void OnUIRender() override
    {
        ...
        // Begin the "Hello" window and allow docking
        ImGui::Begin("Hello", nullptr, ImGuiWindowFlags_NoCollapse);
        ImGui::Button("Button");
        ImGui::End();
